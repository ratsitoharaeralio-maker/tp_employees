        ...
        <div class="card">
            <form method="post" action="emp_form.php<?= $editing ? '?emp_no=' . urlencode($emp_no) : '' ?>">
                <div class="form-group">
                    <input type="hidden" class="form-control" name="mode" value="<?= $editing ? 'edit' : 'add' ?>">
                </div>
                <div class="form-group">
                    <p>Numéro : <input type="number" class="form-control" name="emp_no"
                            value="<?= htmlspecialchars($emp_no) ?>" <?= $editing ? 'readonly' : '' ?>></p>
                </div>
                <div class="form-group">
                    <p>Prénom : <input type="text" class="form-control" name="first_name"
                            value="<?= htmlspecialchars($first_name) ?>"></p>
                </div>
                <div class="form-group">
                    <p>Nom : <input type="text" class="form-control" name="last_name"
                            value="<?= htmlspecialchars($last_name) ?>"></p>
                </div>
                <div class="form-group">
                    <p>Genre :
                ...
                <div class="form-group">
                    <p>Date de naissance : <input type="date" class="form-control" name="birth_date"
                            value="<?= htmlspecialchars($birth_date) ?>">
                    </p>
                </div>
                <div class="form-group">
                    <p>Date d'embauche : <input type="date" class="form-control" name="hire_date"
                ...
                <div class="form-group form-check">
                    <p>
                        <label>
                            <input type="checkbox" class="form-control" name="is_manager" value="1" <?= $is_manager ? 'checked' : '' ?>>
                            Est manager de ce département
                        </label>
                    </p>
                </div>
                <p><input type="submit" class="btn" value="<?= $editing ? 'Modifier' : 'Ajouter' ?>"></p>
            </form>
        </div>
    </div>
</body>
